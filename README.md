...
- [Udemy courses](#udemy-courses)
        - [Azure Databricks administration - ETL Workflow](#azure-databricks-administration---etl-workflow)
        - [Taming Big Data with Apache Spark and Python - Hands On!](#taming-big-data-with-apache-spark-and-python---hands-on)
        - [Azure Databricks & Spark Core For Data EngineersPython/SQL](#azure-databricks--spark-core-for-data-engineerspythonsql)
...
- [Hadoop](#hadoop)
        ...
        - [Expert Hadoop® Administration](#expert-hadoop%C2%AE-administration)
...
- [AWS Microservice](#aws-microservice)
        - [Security and Microservice Architecture on AWS](#security-and-microservice-architecture-on-aws)
        - [Serverless Architectures on AWS, Second Edition](#serverless-architectures-on-aws-second-edition)
- [Useful docs for Spark | PySpark | Spark SQL | Databricks](#useful-docs-for-spark--pyspark--spark-sql--databricks)
...
- [SQL Reference](#sql-reference)
    - [Official Spark docs](#official-spark-docs)
    - [Bryan Cfferky YouTube course - SQL Part](#bryan-cfferky-youtube-course---sql-part)
...
https://udemy.com/course/azure-databricks-administration-etl-workflow/
...
https://learning.oreilly.com/library/view/aws-certified-data/9781119649472/
...
https://learning.oreilly.com/library/view/serverless-architectures-on/9781617295423/

########################################################

# Useful docs for Spark | PySpark | Spark SQL | Databricks
...
## Bryan Cfferky YouTube course - SQL Part

https://www.youtube.com/watch?v=Kz-oYfYEsC0&list=PL7_h0bRfL52qWoCcS18nXcT1s-5rSa1yp&index=8
...
# Mastering Pyspark - docs and examples

https://pyspark.itversity.com/mastering-pyspark.html

# Work with dataframes - write / read | data types and sources

https://learning.oreilly.com/library/view/learning-spark-2nd/9781492050032/ch04.html

# Connectors for Spark SQL and common finction for SQL and Dataframe

https://learning.oreilly.com/library/view/learning-spark-2nd/9781492050032/ch05.html#:-:text=Chapter%205.%20Spark%20SQL%20and%20DataFrames
